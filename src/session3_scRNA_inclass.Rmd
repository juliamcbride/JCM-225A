...
multi_dittoPlot(object = Tcells, 
          ...
          plots = c("ridgeplot"),
          group.by = 'CellCycle')
# you may want to regress out your cell cycle data to limit cell cycle gense overpowering your analysis. we do not do this here 
```
...
Tcells <- RunPCA(
  ...
  npcs = 50)
```
```{r displaying principle components and stratifying by age}
Idents(Tcells) = 'Age'
