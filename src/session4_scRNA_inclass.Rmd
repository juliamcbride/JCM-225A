...
```{r update umap w # of cells, fig.height=3, fig.width=4}
...
for (x in 1:6){
 single_plot = highlight_cluster(selected_tage = tage[x],
  ...
  #create object w all highlight plots
...
```{r make bar plot figures, fig.height=2, fig.width=4}
